...
<head>
    ...
    <style>
        ...
        .alert-box .days { font-size: 28px; font-weight: bold; color: #8a5a00; line-height: 1; }
        .alert-box .days-label { font-size: 12px; color: #7a5800; margin-top: 2px; }
        ...
        .detail-table td:first-child { color: #6b7a99; width: 50%; }
        .detail-table td:last-child { font-weight: bold; color: #1c2333; text-align: right; }
        .note       { background: #f4f7fc; border-radius: 4px; padding: 12px 16px; font-size: 12px; color: #555; line-height: 1.6; margin-bottom: 0; }
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p class="intro">
            This is a friendly reminder that your monthly contribution to
            <strong>{{ $society->name }}</strong> is due soon.
            Please ensure payment is made before the deadline to avoid penalties.
        </p>

        <div class="alert-box">
            <div class="days">{{ $daysLeft }}</div>
            <div class="days-label">day(s) remaining until contribution deadline</div>
        </div>
        ...
        <table class="detail-table">
            ...
            <tr>
                ...
                <td>M {{ number_format($society->minimum_contribution, 2) }}</td>
            </tr>
            <tr>
        ...
        <div class="note">
            &#9432;&nbsp; If you have already made your contribution this month, please disregard this notice.
